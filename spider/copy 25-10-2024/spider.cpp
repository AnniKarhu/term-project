...
{
	//search_parameters	
	search_parameters.start_url = start_data.start_url;  
	search_parameters.search_depth = start_data.search_depth;
	search_parameters.min_word_length = start_data.min_word_length;
	search_parameters.max_word_length = start_data.max_word_length;
	search_parameters.max_threads_num = start_data.threads_num;
	search_parameters.empty_thread_sleep_time = start_data.empty_thread_sleep_time;
	search_parameters.this_host_only = start_data.this_host_only;
...
{
	thread_pool urls_thread_pool(search_parameters);  (start_url, search_depth, max_threads_num, empty_thread_sleep_time, min_word_length, max_word_length);
